...
public class LoginView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(final Context context) {
        addView(LayoutInflater.from(context).inflate(R.layout.view_login, null), new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        loginManager.setPlatformActionListener(new PlatformActionListener() {
            ...
            public void onCancel(final Platform platform, final int i) {
                if (context != null) {
                    ...
                    Toast.makeText(context, R.string.login_cancel, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
